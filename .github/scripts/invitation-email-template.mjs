// ─────────────────────────────────────────────────────────────────────────────
// EnvVault – Invitation Email Template
// Branded HTML matching the app UI (emerald + dark surface). Email-client-safe:
// table layout, inline styles, no external CSS/JS. Exposes a single builder.
// ─────────────────────────────────────────────────────────────────────────────

/**
 * @param {object} p
 * @param {string} p.organizationName
 * @param {string} p.inviterName
 * @param {string} p.role
 * @param {string} p.acceptUrl
 * @param {string} [p.expiresLabel]  Human-readable expiry, e.g. "July 25, 2026"
